            ...
            <div class="user-profile-top">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div>
                                <strong class="fs-4 text-capitalize">{{ $profile['name'] }}</strong> <small class="fw-bold">
                                    (Profile ID : {{ $profile['profile_id'] }})</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="user-profile-view">
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-md-12 col-sm-12 col-12 text-center">
                                <div class="">
                                    <img src="{{ $profile->image ? asset('image/profile/' . $profile->image) : asset('image/common/' . ($profile->gender == 'Male' ? 'default-male.jpg' : 'default-female.jpg')) }}"
                                        class="object-fit-contain img-fluid" alt="user-profile" width="200"
                                        height="150">
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12 mt-4 mt-lg-0">
                                <div class="about-user">
                                    <div class="row user-row ms-4 ms-sm-4 ms-lg-0">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 user-col">
                                            <i class="fa-solid fa-hand-fist fs-4 user-view-icon"></i>
                                            <label for="">Raasi</label>
                                            <h6>{{ $profile['raasi'] }}</h6>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 user-col">
                                            <i class="fa-solid fa-star-of-david fs-4 user-view-icon"></i>
                                        ...
                                        <div class="row usr-basc-detls-row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-md-0 mt-sm-3 mt-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="prof-desc"><span>:</span> Tamil,hindi, English, Malayalam
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <label for="" class="prof-label">About Yourself &
                                                        Family</label>
                                                    <div class="prof-desc"><span>:</span> Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Deserunt dolorum eos rem est placeat
                                                        sit illo repellat minima magni fugiat.</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row usr-basc-detls-row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 ">
                                                <div>
                                                    ...
                                                    <div class="prof-desc"><span>:</span> {{ $profile['community'] }}
                                                    </div>
                                                </div>
                                                <div>
